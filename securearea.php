...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <script>
		...
		{
			try { b64pad } catch(e) { b64pad=''; }//fin del try catch
...
<div class="container">
      ...
      <form role="form" class="form-signin">
        ...
        <input type="email" autofocus="" required="" placeholder="Nombre Usuario" class="form-control" id="txtUsuario">
        <input type="password" required="" placeholder="Clave" class="form-control" id="txtPassword">
        <button type="submit" class="btn btn-lg btn-primary btn-block" id="ingresar">Ingresar</button>
      </form>
